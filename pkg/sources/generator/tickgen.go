...
func NewMemGen(
	...
	forwarder, err := forward.NewInterStepDataForward(vertexInstance.Vertex, gensrc, destinations, fsd, onFullWritingStrategies, mapApplier, fetchWM, publishWM, forwardOpts...)
	if err != nil {
		return nil, err
	}
