...
func NewKafkaSource(
	...
	forwarder, err := forward.NewInterStepDataForward(vertexInstance.Vertex, kafkasource, destinations, fsd, onFullWritingStrategies, mapApplier, fetchWM, publishWM, forwardOpts...)
	if err != nil {
