...
func New(
	...
	h.forwarder, err = forward.NewInterStepDataForward(vertexInstance.Vertex, h, destinations, fsd, onFullWritingStrategies, mapApplier, fetchWM, publishWM, forwardOpts...)
	if err != nil {
