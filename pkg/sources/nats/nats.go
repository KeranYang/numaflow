...
func New(
	...
	forwarder, err := forward.NewInterStepDataForward(vertexInstance.Vertex, n, destinations, fsd, onFullWritingStrategies, mapApplier, fetchWM, publishWM, forwardOpts...)
	if err != nil {
